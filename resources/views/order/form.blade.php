...
<div class="d-none form-group {{ $errors->has('remark') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control" rows="5" name="remark" type="textarea" id="remark" value="{{ isset($order->remark) ? $order->remark : ''}}" d-none ></textarea>
...
<div class="d-none form-group {{ $errors->has('checking_at') ? 'has-error' : ''}}">
...
<div class="d-none form-group {{ $errors->has('paid_at') ? 'has-error' : ''}}">
...
<div class="d-none form-group {{ $errors->has('cancelled_at') ? 'has-error' : ''}}">
...
<div class="d-none form-group {{ $errors->has('completed_at') ? 'has-error' : ''}}">
